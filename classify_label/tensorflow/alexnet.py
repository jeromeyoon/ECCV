...
n_input = n_col * n_row * n_ch # MNIST data input (img shape: 28*28)
n_classes = 13 # MNIST total classes (0-9 digits)
...
def alex_net(_X, _weights, _biases, _dropout):
    ...
    _X = tf.reshape(_X, shape=[-1, n_col, n_row, n_ch])
...
weights = {
    ...
    'wd1': tf.Variable(tf.random_normal([1*1*256, 512])),
